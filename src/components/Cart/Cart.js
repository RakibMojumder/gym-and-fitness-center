    ...
    return (
        <div>
            <div className="author-info">
                <div className='flex flex-col md:flex-row items-center pt-0 lg:pt-4 pb-6 my-0 lg:my-4 border-b border-slate-500'>
                ...
                <div className="physical-info rounded-lg py-3 grid grid-cols-3 md:grid-cols-2 lg:grid-cols-3 items-center">
                    ...
                    <div className='col-span-1 md:col-span-2 lg:col-span-1 mx-auto lg:mx-0 md:mt-5 lg:mt-0 shadow-lg shadow-cyan-500/50 flex justify-center items-center rounded-full h-[90px] w-[90px] text-center border-2 border-cyan-500'>
                        <div>
            ...
            <div className="added-break-section mt-10">
                ...
                <div className='grid grid-cols-5 md:grid-cols-3 lg:grid-cols-5 justify-between shadow-lg shadow-cyan-700/50 py-5 rounded-md px-2 drop-shadow-2xl'>
                    ...
                    <div className='text-center md:mt-5 lg:mt-0'>
