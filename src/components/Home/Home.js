    ...
    return (
        <div>
            <div className='home grid grid-cols-12 md:grid-cols-12'>
                <div className="players-section mt-10 px-8 col-span-7 md:col-span-8 lg:col-span-9">
                    <div className="player-header">
                        <h1 className='uppercase text-cyan-400 text-4xl font-bold'><FontAwesomeIcon icon={faFootball}></FontAwesomeIcon> Super Sixers</h1>
