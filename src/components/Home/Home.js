...
const Home = () => {
    ...
    return (
        <div>
            <div className='home grid grid-cols-1 md:grid-cols-12'>
                <div className="players-section mt-20 mb-32 px-8 col-span-1 md:col-span-8 lg:col-span-9">
                ...
                <div className="activity-section col-span-1 md:col-span-4 lg:col-span-3 px-5 mt-20">
